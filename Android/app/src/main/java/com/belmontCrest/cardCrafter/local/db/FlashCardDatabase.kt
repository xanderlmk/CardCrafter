package com.belmontCrest.cardCrafter.local.db
...
import com.belmontCrest.cardCrafter.local.db.daos.CardDao
import com.belmontCrest.cardCrafter.local.db.daos.CardTypesDao
import com.belmontCrest.cardCrafter.local.db.daos.DeckDao
import com.belmontCrest.cardCrafter.local.db.daos.DueCardsDao
import com.belmontCrest.cardCrafter.local.db.daos.SavedCardDao
...
import com.belmontCrest.cardCrafter.local.db.tables.QOrAConverter
...
import com.belmontCrest.cardCrafter.local.db.tables.TimeConverter
import com.belmontCrest.cardCrafter.local.db.tables.customCardInit.ParamConverter
...
import com.belmontCrest.cardCrafter.model.migrations.MIGRATION_34_35
...
@Database(
    entities = [
        ...
        ImportedDeckInfo::class, SyncedDeckInfo::class, CardInfo::class,
        NullableCustomCard::class
    ],
    version = 35, exportSchema = true
)
@TypeConverters(
    TimeConverter::class, ListStringConverter::class, QOrAConverter::class, ParamConverter::class
)
