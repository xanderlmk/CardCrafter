...
suspend fun populateDatabase(
    ...
    val historyDeck = Deck(
        ...
        uuid = "a82779d1-e59a-47a9-9a16-c09b0ca569b4",
        cardsLeft = 20,
        lastUpdated = nextReviewDate
    )
    "2cbffea8-3785-49d6-8e86-00a4312a7fa2"
    deckDao.insertDeck(historyDeck)
    val motorcycleDeck = Deck(
        name = "Motorcycle Written Exam",
        nextReview = nextReviewDate,
        uuid = "a0597fad-9392-431a-a399-00bf5ef5bbad",
        cardsLeft = 20,
        lastUpdated = nextReviewDate
    )
    ...
    cardDao.insertCard(
        Card(
            ...
            totalPasses = 0,
            type = "three",
            deckCardNumber = motorCycleCards.size,
            cardIdentifier = "$mcUuid-${motorCycleCards.size}",
            reviewsLeft = motorcycleDeck.reviewAmount
        )
    )
